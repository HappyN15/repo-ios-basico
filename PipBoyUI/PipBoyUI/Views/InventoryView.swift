...
struct InventoryView: View {
    let inventario: [InventoryItem] = [
        ...
        InventoryItem(nombre: "Stimpak", categoria: "Objetos", daño: nil, defensa: nil, peso: 0.1, valor: 60, descripcion: "Cura heridas al instante y restaura extremidades rotas."),
...
struct InventoryDetailView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Peso: \(item.peso, specifier: "%.1f")").foregroundColor(.green)
            Text("Valor: \(item.valor)").foregroundColor(.green)
